                    ...
                    ?>
                      ...
                      <?php }} ?>
                        <tr>
                            ...
                            <td><input name="subcategory_sr" class="form-control" value="<?=$subcategory_sr;?>" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){coba('form1');}else{return false;};"/></td>
...
<script type="text/javascript">
    $(document).ready(function (){
        ...
        function indexx(){
        window.location.replace("<?php echo base_url(); ?>article");
        }
        function updatex(id){
        window.location.replace("<?php echo base_url(); ?>article/update/"+id+"/<?=($this->uri->segment(3)) ? $this->uri->segment(3) : 0 ;?>");
        }
         function deletex(id){
